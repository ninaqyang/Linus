...
SWIFT_CLASS("_TtC19ExpandingCollection22BasePageCollectionCell")
...
@interface BasePageCollectionCell (SWIFT_EXTENSION(ExpandingCollection))
/// Open or close cell.
...
SWIFT_CLASS("_TtC19ExpandingCollection28ExpandingTableViewController")
...
@interface ExpandingTableViewController (SWIFT_EXTENSION(ExpandingCollection))
...
SWIFT_CLASS("_TtC19ExpandingCollection23ExpandingViewController")
...
@interface ExpandingViewController (SWIFT_EXTENSION(ExpandingCollection))
@end
...
@interface ExpandingViewController (SWIFT_EXTENSION(ExpandingCollection)) <UICollectionViewDataSource, UICollectionViewDelegate>
...
@interface UIView (SWIFT_EXTENSION(ExpandingCollection))
@end
